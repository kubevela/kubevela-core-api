...
// ApplicationRevisionSpecApplyConfiguration represents an declarative configuration of the ApplicationRevisionSpec type for use
// with apply.
type ApplicationRevisionSpecApplyConfiguration struct {
	ApplicationRevisionCompressibleFieldsApplyConfiguration `json:",inline"`
	Compression                                             *ApplicationRevisionCompressionApplyConfiguration `json:"compression,omitempty"`
}

// ApplicationRevisionSpecApplyConfiguration constructs an declarative configuration of the ApplicationRevisionSpec type for use with
// apply.
func ApplicationRevisionSpec() *ApplicationRevisionSpecApplyConfiguration {
	return &ApplicationRevisionSpecApplyConfiguration{}
}
...
func (b *ApplicationRevisionSpecApplyConfiguration) WithApplication(value *ApplicationApplyConfiguration) *ApplicationRevisionSpecApplyConfiguration {
	b.Application = value
	return b
}
...
func (b *ApplicationRevisionSpecApplyConfiguration) WithComponentDefinitions(entries map[string]*coreoamdevv1beta1.ComponentDefinition) *ApplicationRevisionSpecApplyConfiguration {
...
func (b *ApplicationRevisionSpecApplyConfiguration) WithWorkloadDefinitions(entries map[string]WorkloadDefinitionApplyConfiguration) *ApplicationRevisionSpecApplyConfiguration {
...
func (b *ApplicationRevisionSpecApplyConfiguration) WithTraitDefinitions(entries map[string]*coreoamdevv1beta1.TraitDefinition) *ApplicationRevisionSpecApplyConfiguration {
...
func (b *ApplicationRevisionSpecApplyConfiguration) WithPolicyDefinitions(entries map[string]PolicyDefinitionApplyConfiguration) *ApplicationRevisionSpecApplyConfiguration {
...
func (b *ApplicationRevisionSpecApplyConfiguration) WithWorkflowStepDefinitions(entries map[string]*coreoamdevv1beta1.WorkflowStepDefinition) *ApplicationRevisionSpecApplyConfiguration {
...
func (b *ApplicationRevisionSpecApplyConfiguration) WithPolicies(entries map[string]v1alpha1.Policy) *ApplicationRevisionSpecApplyConfiguration {
...
func (b *ApplicationRevisionSpecApplyConfiguration) WithWorkflow(value apiv1alpha1.Workflow) *ApplicationRevisionSpecApplyConfiguration {
	b.Workflow = &value
	return b
}
...
func (b *ApplicationRevisionSpecApplyConfiguration) WithReferredObjects(values ...common.ReferredObject) *ApplicationRevisionSpecApplyConfiguration {
	for i := range values {
...
func (b *ApplicationRevisionSpecApplyConfiguration) WithCompression(value *ApplicationRevisionCompressionApplyConfiguration) *ApplicationRevisionSpecApplyConfiguration {
	b.Compression = value
	return b
}
